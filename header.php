...
<nav class="bg-white shadow-lg border-b border-gray-200">
        ...
        <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-8">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="repacking.php" class="<?php echo $current_page == 'repacking' ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/>
                        </svg>
                        Repacking
                    ...
                    <a href="rolls.php" class="<?php echo $current_page == 'rolls' ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative dropdown" onmouseenter="showDropdown(this)" onmouseleave="hideDropdown(this)">
                        ...
                        <div class="dropdown-menu bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
                            <div class="py-1">
                                ...
                                <a href="quotation_list.php" class="<?php echo in_array($current_page, ['quotation_list', 'quotation_create', 'quotation_view']) ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> block px-4 py-2 text-sm transition-colors">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                    </svg>
                                    📋 Quotations
                                ...
                                <a href="sales_payments.php" class="<?php echo in_array($current_page, ['sales_payments', 'sales_list', 'payment_management', 'customer_pending_bills', 'add_invoice_payment']) ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> block px-4 py-2 text-sm transition-colors">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                    </svg>
                                    📊 Sales & Payments
                                </a>
                                <a href="payment_history.php" class="<?php echo $current_page == 'payment_history' ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> block px-4 py-2 text-sm transition-colors">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative dropdown" onmouseenter="showDropdown(this)" onmouseleave="hideDropdown(this)">
                        ...
                        <div class="dropdown-menu bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
                            <div class="py-1">
                                <a href="sales_reports.php" class="<?php echo $current_page == 'sales_reports' ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> block px-4 py-2 text-sm transition-colors">
                                    <svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    📊 Sales Reports
    ...
    <div id="mobileMenu" class="md:hidden hidden border-t border-gray-200">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="quotation_list.php" class="<?php echo in_array($current_page, ['quotation_list', 'quotation_create', 'quotation_view']) ? 'bg-primary text-white' : 'text-gray-700 hover:bg-gray-100'; ?> block px-3 py-2 rounded-md text-base font-medium flex items-center">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Quotations
